...
do
    ...
    sed -e "s|OC_PROJECT|${OC_PROJECT}|" \
        ...
        -e "s|GFM_MLFLOW_STORAGE|${GFM_MLFLOW_STORAGE}|" \
        -e "s|GFM_FT_DATA_STORAGE|${GFM_FT_DATA_STORAGE}|" \
        -e "s|GFM_FT_FILES_STORAGE|${GFM_FT_FILES_STORAGE}|" \
        -e "s|GFM_FT_MODELS_STORAGE|${GFM_FT_MODELS_STORAGE}|" \
        -e "s|INFERENCE_AUXDATA_STORAGE|${INFERENCE_AUXDATA_STORAGE}|" \
        -e "s|INFERENCE_SHARED_STORAGE|${INFERENCE_SHARED_STORAGE}|" \
        -e "s|GENERIC_PYTHON_PROCESSOR_STORAGE|${GENERIC_PYTHON_PROCESSOR_STORAGE}|" \
        -e "s|REDIS_MASTER_STORAGE|${REDIS_MASTER_STORAGE}|" \
        -e "s|REDIS_REPLICAS_STORAGE|${REDIS_REPLICAS_STORAGE}|" \
        ...
        -e "s|FTUNING_IMAGE_PULL_POLICY_VALUE|${FTUNING_IMAGE_PULL_POLICY_VALUE}|" \
