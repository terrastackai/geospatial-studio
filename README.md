...
*If you want detailed description 📚 of the deployment process on an external cluster [see here 📚](./docs/detailed_deployment_cluster.md).*
...
*If you want detailed description 📚 of the local deployment process [see here 📚](./docs/detailed_deployment_local.md).*
